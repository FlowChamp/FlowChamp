...
export const SET_ACTIVE_CHART_REQUEST = 'SET_ACTIVE_CHART_REQUEST';
export const SET_ACTIVE_CHART_SUCCESS = 'SET_ACTIVE_CHART_SUCCESS';
export const SET_ACTIVE_CHART_FAILURE = 'SET_ACTIVE_CHART_FAILURE';
